       ...
       <div class="borrow_users_tab">
          ...
          <div class="borrow_content">
            <div class="borrow_content_title_box">
              <div class="borrow_content_title">Book Borrows Details</div>
                    ...
                    if ($result4->num_rows > 0) {
                        while($row4 = $result4->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>
                                      <button class='btn btn-primary btn-sm' onclick=\"toggleBorrowForm()\">Edit</button>
                        ...
                        echo "<tr><td colspan='4'>No borrow records found.</td></tr>";
                    }
                  ?>
                </tbody>
              </table>
